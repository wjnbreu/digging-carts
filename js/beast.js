    ...
    $(function() {
        ...
        e = function(e) {
            ...
            for (n = l = 0, c = e.length; l < c; n = ++l) {
                ...
                s = o.makeHtml(d.bio);
                i = "<div class='slide' data-order='" + n + "'><div class='img-wrap'><a class='arrow-left' href></a><a class='arrow-right' href></a><img src='" + r + "'/></div><h2>" + d.composerName + "</h2><p>" + s + "</p></div>";
