...
$(function() {
  var APIModules, addComposers, addInitialVideosByLanguage, addMixes, addPlayer, addShareText, addVideoTitles, additionalVideoObject, brightcoveVideos, changeAdditionalVideo, changeVideo, composerObject, converter, currentCountry, currentVideoCallback, detectMobile, findLocation, getData, getHeight, init, initCount, isMobile, magazineObject, mixObject, modVP, onMediaEventFired, onPlayerReady2, player, player2, playerData, playerIDS, playerTemplate, prepInit, removeSpinner, resizePlayer, resizeVid, sendHeight, setupBinds, setupYouTube, swapVideo, targetVideo, updateInitPlayerData, vidRatio, videoObject;
  composerObject = {};
  videoObject = {};
  mixObject = {};
  ...
  setupBinds = function() {
    ...
    $('a.pulldown').click(function(event) {
      event.preventDefault();
